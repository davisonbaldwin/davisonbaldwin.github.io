...
export const SYSTEM = {
  ...
  interfaces: {
    ...
    'front-corner-pack-outboard': {
      kind: 'face', axis: 'z', at: 0.6425, tol: 0.011,
    ...
    /* THE SADDLE FOOT, new for Gen 14. Each rear saddle's two tubes leave a
       foot on the top face of suspension-9's rear upright body, which that
       module builds as a chamfered box of 0.085 by 0.36 by 0.032 centered at
       (-1.45, 0.40, 0.600): its top face is y 0.580 over |z| 0.584 to 0.616,
       x -1.4925 to -1.4075, with the upper joint bolt stacks standing on it
       at x -1.41 and -1.49 to y 0.592. The foot sits between the stacks.
       Declared on the y axis with no extent, because the band itself runs
       below the face at its two ends and above it everywhere else, so neither
       extent is a true statement about the part; what the checker proves is
       that a real vertex of the foot is ON the face. suspension-9 is carried
       unchanged and declares no half, so this key WARNS as unmet rather than
       fails, exactly as the pant bracket key does one axle forward. */
    'rear-saddle-foot': {
      kind: 'face', axis: 'y', at: 0.5800, tol: 0.002,
      part: 'rear-saddles', mirrored: false,
      note: 'suspension-9 rear upright top face. The saddle foot seats on it at (-1.450, |z| 0.600) between the upper joint bolts; nothing of the saddle reaches the face but the foot.',
    },
  },
  parts: {
    tires: {
    ...
    'front-pants': {
      ...
      mass: 5.5,    /* Gen 20: 5.3 x 1.0364, the drawn area over wheels-17's (2.543 m2 against 2.453), tools measured: the disc floor to 0.045 and the nose cap to 145 degrees */
      count: 2,
      specs: [
    ...
    'rear-saddles': {
      name: 'Rear wheel saddles',
      tagline: 'The pant idea at the axle that does not steer: a crown band on the upright, 18 mm over the tread, covering exactly what the wall cannot reach.',
      mass: 2.3,    /* Gen 20: 1.5 x 1.5309, the drawn area over wheels-17's (0.816 m2 against 0.533), tools measured: both arcs carried from 65 and 75 degrees to 147, the band wrapping the wheel to 39 mm off the road, its ends and deep runs tapered where the envelope ruled */
      count: 2,
      specs: [
        ['Counterpart', 'body-12 and body-13 rear spats, 12 kg: the wall at |z| 0.84 from y 0.18 to 0.52, which hides 0.017 m2 of the rear pair under the third revision of tools/aero.js'],
        ['Band', 'r 0.373 inner about the rear axle, 4 mm carbon sandwich, |z| 0.6725 to 0.8075 over the crown (the tire\'s own section, no lip), the outer edge tapering to 0.790 over the last 15 degrees at each end; from 65 degrees ahead of the top (x -1.108, y 0.514) to 75 behind (x -1.814, y 0.452)'],
        ['Inboard edge', '0.6725 over the crown and tail; tapering to 0.695 from 45 to 65 degrees ahead, for autonomy-13\'s compute corner at (-1.142, 0.552, 0.656) under 3 degrees of rear steer'],
        ['Tubes', 'Two aluminum tubes at r 0.007 per side, off a foot on suspension-9\'s rear upright top face at y 0.580: up at |z| 0.624 to y 0.700, then a 40 mm jog to the band\'s inboard edge at 0.664'],
        ['Tightest', 'tools/envelope.sh on gen15: the band\'s nose end to the spat wall\'s blend at 3 degrees of rear steer and full rebound, 20 mm after the taper (wheels-14: 1.8); 17 mm, riser to the flank; 19 mm, jog to the tread shoulder'],
        ['Mass', '0.43 kg of 4 mm carbon sandwich at 3.5 kg/m2 over 0.123 m2, 0.16 of aluminum tube, 0.17 of foot, clips and fixings: 0.76 a corner, unsprung'],
        ['Maturity', 'Production practice on motorcycles and record cars; a fairing on the hub of a driven, rear-steered road wheel is a pilot-line claim'],
      ],
      how: 'Gen 17: the band rides 20 mm inboard with its wheel: outer edge 0.7875, inboard edge 0.6525, the tubes\' foot still on the upright\'s top face at y 0.580, which suspension-17 moved 20 mm in with the upright. body-17\'s spat wall follows to 0.81, 22.5 mm off the face, and tools/envelope.sh decides the last 10. Exposed rear tire 0.0307 m2 against 0.0347.\n\nWhat the rear tire shows the air, measured first. Under the third revision the rear pair of Gen 13 reads 0.0880 m2 of rotating tire outside the car\'s filled outline, per axle, against what stands beside or ahead of it. Beside and ahead of the rear tire stand battery-11\'s sill at |z| 0.66 to 0.78 from y 0.104 to 0.42 (its end 35 mm ahead of the rubber), body-13\'s shoulder and pan at 0.78 from 0.42 to about 0.50 and thinning to 0.69 by 0.56, and the spat wall\'s leading blend from 0.78 to 0.8075 over y 0.18 to 0.52. So from y 0.104 up to about 0.51 the tire is already hidden in the projection except for a 27.5 mm outer band below the wall\'s foot; what is exposed is the crown, from the shoulder\'s top at about 0.51 to the tire top at 0.71 over the full 135 mm section, and the strip under the sill\'s floor at 0.104, of which the 80 mm nearest the road is the contact strip no fairing reaches. The wall at 0.84 is edge-on and hides none of that; its closure is behind the wheel and the rule does not count it. That decomposition is the drawing: the saddle is a crown band and nothing else.\n\nThe band. 4 mm carbon sandwich bent to r 0.373 about the rear axle, 18 mm over the tread, exactly the tire\'s section wide from |z| 0.6725 to 0.8075 so that its edges stand on the tire\'s face planes with no lip either side: in the frontal projection a lip is new area, and the tire\'s own rectangle is in the union already. It runs from 65 degrees ahead of the top, where its end at (x -1.108, y 0.514) stands 18 mm behind the shoulder panel\'s last vertex at -1.090 and covers the crown down to where the shoulder takes over, to 75 degrees behind the top at (x -1.814, y 0.452), inside the wall\'s straight run and 86 mm ahead of its closure. Its inboard edge sits on the tire\'s face except from 45 to 65 degrees ahead, where it tapers to 0.695: autonomy-13\'s compute deck has a corner at (-1.142, 0.552, 0.656), 16.5 mm inboard of the face at rest, and a band end 0.34 m from the axle swings 19 mm at 3 degrees of rear steer. The taper holds 20 mm there and exposes about 0.001 m2 of tread above the shoulder. Bump moves the band in y only, 80 mm each way, and above the rear tire the body draws nothing outboard of |z| 0.590 from y 0.608 up, so the band meets nothing at full bump.\n\nThe tubes, and where they run. suspension-9\'s rear upright is a chamfered box of 0.085 by 0.36 by 0.032 centered at (-1.45, 0.40, 0.600), top face y 0.580, with its upper joint bolt stacks standing on that face at x -1.41 and -1.49 to y 0.592. The foot is a 28 by 44 mm plate between them, overhanging the face by 18 mm outboard into air, two bolts down into the casting, and the two tubes rise from it at x -1.457 and -1.443: up at |z| 0.624 to y 0.700, 17 mm outboard of body-13\'s flank at 0.600 (risen at 0.600 it would be 11.3 mm inside the skin, because 0.600 is the skin\'s own plane), 4 mm in x from the bolt stacks on the same rigid body, 19 mm inboard of drivetrain-9\'s rotor ring face at 0.65 and 41 mm inboard of the tire\'s section maximum; then a 40 mm jog outboard over 26 mm of rise to the band\'s inboard edge at |z| 0.664, passing the tire\'s upper shoulder at 0.690 with 19 mm; and a 22 by 12 mm clip straddling the edge. All of it is on the upright, so it rear-steers and bumps with the band and the gaps to the wheel are constant; the gap to the flank is 17 mm at every bump because the flank is vertical.\n\nMass, derived: 140 degrees at r 0.375 mean by 0.135 is 0.123 m2, 0.43 kg at 3.5 kg/m2; two tubes of 0.19 m each at r 0.007 in aluminum, 0.16; foot, clips and fixings 0.17: 0.76 a corner, 1.5 the pair, all unsprung, on a corner whose unsprung mass is about 21 kg before the motor ring is counted.',
      why: 'Because the rear wheel was the largest open term on the car and the wall beside it was measured, under the method\'s own third revision, to be hiding 17 percent of what it was built to hide. design/gen13.md section 11 declined rear pants on the record: the spats are body parts in the section march and a wheel-mounted shell is not. That is still true and it is why this is a band and not a pod. The wall keeps its two jobs, the tire\'s side fairing and the underbody channel\'s side wall, both measured; the march keeps its sections; the band takes the crown the wall cannot reach and the rule charges it as a static shell in the air, which is what it is. A shell on the hub has a constant gap to its tire through bump and rear steer for the same reason the pant has one through lock, and the body-12 enclosure is the record of what a body-fixed crown cover costs when it has to be drawn to bump clearance.',
      fail: [
        'The band is 18 mm over A tire that grows, the same sentence the front pant carries and for the same reason. A stone on the crown of a driven wheel has 18 mm to lodge in and no liner is drawn.',
        'The riser passes 17 mm from the body flank, a wheel-borne tube beside a sprung panel, and the suspension\'s lateral compliance under cornering is not in the model; at the flank\'s own plane it would be 11.3 mm inside it.',
        'The foot is between the upper joint bolts with 6 mm A side, on a face suspension-9 never drew a boss for. The upright is carried and declares no half, so the checker reports the key unmet; a rear-suspension generation that redraws the upright owes it a boss and a declaration.',
        'Unsprung mass, 0.76 kg a corner at r 0.37, on a corner that already carries a motor ring. Small against the ring, not nothing, and unmeasured in the ride.',
        'The wall and the band are two fairings on one wheel, the wall for the side and the band for the crown, and neither is the one an aerodynamicist would draw with a free hand, which is a single skirt to the tire top. The method measured that skirt on body-12 and priced it at +0.114 m2 because a body-fixed crown must clear bump travel; the band is the answer that costs 0.006. The honest statement is that the rear wheel is faired in two pieces because the ruler made it so.',
      ],
      explode: [0, 0, 1.15],
    },
    'rear-wheels': {
...
const FRONTZ = 0.72;             // front wheel center |z|, the Gen 9 move
...
const PANT = {
  ...
  ZOUT: 0.8255,    // disc outer face, 18 mm off the tire section max at 0.8075, carried
...
/* ── THE REAR SADDLES, new for Gen 14. World coordinates about the rear axle
   at (P.axleR, P.wheelY, s * REARZ); s = sign(z) so +s is outboard. A crown
   band only: the sill, the shoulder, the pan and the wall's leading blend
   already stand ahead of or beside the rear tire from y 0.104 to about 0.51
   in the method's projection, and the wall at 0.84 is the tire's side
   fairing. The header carries the decomposition and every clearance; the
   panel carries the why. Nothing here spins. ── */
const SADDLE = {
  R: 0.377,        // band OUTER radius about the rear axle: inner 0.373, 18 mm over the tire's 0.355
  ZIN: 0.6725,     // inboard edge: the tire's section maximum plane, no lip
  ZOUT: 0.8075,    // outboard edge: the tire's section maximum plane, no lip, over the crown
  ZOUT_END: 0.772, // Gen 20: the end bands yield to the leaned wall. Between 55 and 67 degrees each side the band's outer face tapers from the tire's plane to 0.772, finished by 57 degrees so that at full droop, which carries the band 80 mm down the body, no point beside the wall's leaned band is still on the tire's plane; 0.790 at the old 65 degree end stood 2 mm from the wall at 3 degrees of rear steer plus droop, and Gen 19's own clearance class at this pair is 16. What it costs is measured and booked: the tire's shoulder band at y 0.44 to 0.53 comes out from behind its fairing and the rear exposure pays about 0.003 m2, priced against the 0.0085 m2 of silhouette the leaned wall gives back
  ZIN_NOSE: 0.695, // inboard edge from 35 to 65 degrees ahead (wheels-14: from 45): autonomy's compute corner at (-1.187, 0.542, 0.659) under 3 deg of rear steer and full rebound, tools/envelope.sh
  ZIN_DEEP: 0.724, // Gen 20: the deep nose arc's inboard edge, from 75 degrees down so full droop still lands past it. battery-17's disconnect stands at (-1.083, 0.270, 0.675) and the arc's forward-most reach is x -1.073 at 90 degrees: at 3 degrees of rear steer plus full droop the 0.6725 edge read 2.4 mm from it, 0.710 read 7.6 and 0.718 read 10.6; 0.724 reads 15.4, the 15 the fairings have owed their partners since Gen 15. The tire's inner shoulder it uncovers is inboard of the silhouette and the term does not pay, measured at every step of this ladder of retreats
  TH: 0.004,       // laminate
  ARC_NOSE: 147,   // Gen 20: down the leading side to y 0.039 at x -1.245 (wheels-15: 65, stopping at y 0.514 for the shoulder panel; the deep arc passes 185 mm behind the sill's end and the envelope referees the rest)
  ARC_TAIL: 147,   // Gen 20: down the trailing side to y 0.039 at x -1.655 (wheels-15: 75, y 0.452); the arc's widest x is -1.827 at 90 degrees, 73 mm ahead of the wall's closure, and it narrows again below
  FOOT_Y: 0.580,   // suspension-9 rear upright top face
};

function rearSaddlePart(s) {
  const g = lib.part('rear-saddles', [0, 0, s * 1.15]);
  const cx = P.axleR, cy = P.wheelY;

  /* THE BAND: a closed thin section lofted from the tail at -ARC_TAIL over
     the crown to the nose at +ARC_NOSE (positive is forward), outer face
     at R, inner at R - TH, exactly the tire's section wide. */
  /* Gen 15: the inboard taper starts at 35 degrees, not 45: autonomy-15's
     compute deck has a corner at (-1.187, 0.542, 0.659) on the driver side,
     beside the saddle's nose at 40 to 50 degrees, and at 3 degrees of rear
     steer plus full rebound the edge at 0.6725 read 8.6 mm from it */
  const zin = (deg) => {
    if (deg <= 35) return SADDLE.ZIN;
    const t = Math.min(1, (deg - 35) / 10);
    let z = SADDLE.ZIN + (SADDLE.ZIN_NOSE - SADDLE.ZIN) * t;
    /* Gen 20: the second inboard step, for the pack's disconnect; from 75
       so that full droop, 80 mm down the body, still lands past it */
    const d = Math.min(1, Math.max(0, (deg - 75) / 10));
    z += (SADDLE.ZIN_DEEP - SADDLE.ZIN_NOSE) * d;
    return z;
  };
  /* Gen 15: the outer edge comes off the tire face over the last 15 degrees
     at each end, because those ends are 0.34 m from the axle and swing 19 mm
     at 3 degrees of rear steer into the wall's leading blend (nose) and
     trailing closure (tail) */
  const zout = (deg) => {
    /* Gen 20: symmetric, and finished by 57 degrees, because full droop
       carries the band 80 mm down the body: the point that stands beside
       the wall's top corner at droop is at 49 degrees at rest, not 63.
       See ZOUT_END for what the early taper costs and buys. */
    const t = Math.max(0, (Math.abs(deg) - 45) / 12);
    return SADDLE.ZOUT + (SADDLE.ZOUT_END - SADDLE.ZOUT) * Math.min(1, t);
  };
  const rows = [];
  for (let deg = -SADDLE.ARC_TAIL; deg <= SADDLE.ARC_NOSE + 1e-9; deg += 10) {
    const th = (deg * Math.PI) / 180;
    const x = cx + SADDLE.R * Math.sin(th), y = cy + SADDLE.R * Math.cos(th);
    const xi = cx + (SADDLE.R - SADDLE.TH) * Math.sin(th), yi = cy + (SADDLE.R - SADDLE.TH) * Math.cos(th);
    const z0 = zin(deg), z1 = zout(deg);
  ...
  g.add(lib.shell(lib.crease(lib.loft(rows, M.paint, true), 40)));
  /* the two open ends, capped */
  for (const deg of [-SADDLE.ARC_TAIL, SADDLE.ARC_NOSE]) {
    const th = (deg * Math.PI) / 180;
    const z0 = zin(deg), zw = zout(deg) - z0;
    const cap = lib.box(SADDLE.TH, 0.0015, zw, M.paint);
    cap.position.set(cx + (SADDLE.R - SADDLE.TH / 2) * Math.sin(th), cy + (SADDLE.R - SADDLE.TH / 2) * Math.cos(th), s * (z0 + zw / 2));
    cap.rotation.z = -th;
    g.add(cap);
  }

  /* THE FOOT AND THE TUBES. The foot is a 24 by 28 mm plate on the upright's
     top face at y 0.580, |z| 0.586 to 0.614, between the upper joint bolt
     stacks at x -1.41 and -1.49; two bolts down into the casting. Each tube
     rises at |z| 0.600 to y 0.623 (beside the stacks, 6 mm in x), steps
     outboard to 0.652 over the rotor ring (y 0.587) and the rim flange edge
     (r 0.244, y 0.599), rises at 0.652 beside the tire's bead (0.683) and
     section maximum (0.6725) to y 0.726, and lands on the band's inboard
     edge through a clip straddling it. */
  const foot = lib.box(0.028, 0.006, 0.044, M.castAlu);
  foot.position.set(cx, SADDLE.FOOT_Y + 0.003, s * 0.612);
  g.add(foot);
  /* two bolt heads, six-sided: the module is 956 triangles under its budget
     with the saddles drawn lean, and a hex fastener costs more than that */
  for (const dx of [-0.008, 0.008]) {
    const b = lib.cyl(0.004, 0.006, M.steel, 6);
    b.position.set(cx + dx, SADDLE.FOOT_Y + 0.009, s * 0.600);
    g.add(b);
  }
  /* THE RISER IS AT |z| 0.624, NOT 0.600. A first draft rose at 0.600 and
     the checker put it 11.3 mm inside body-13's skin: the flank is at 0.600
     from y 0.62 up and its arch return is at 0.59 to 0.60 over 0.608 to
     0.62, so 0.600 is the skin's own plane. At 0.624 the tube is 17 mm
     outboard of the flank, 4 mm in x from the upright's own bolt stacks on
     the same rigid body, and 41 mm inboard of the tire's section maximum. */
  for (const dx of [-0.007, 0.007]) {
    const x0 = cx + dx;
    const thT = Math.asin(dx / (SADDLE.R - SADDLE.TH / 2));
    const yEdge = cy + (SADDLE.R - SADDLE.TH / 2) * Math.cos(thT);
    g.add(lib.tube([
      [x0, SADDLE.FOOT_Y + 0.006, s * 0.624],
      [x0, 0.700, s * 0.624],
      [x0, yEdge, s * 0.664],
    ], 0.007, M.castAlu, false, 8));
    const clip = lib.box(0.022, 0.012, 0.014, M.castAlu);
    clip.position.set(x0, yEdge, s * 0.6715);
    g.add(clip);
  }
  g.position.z = s * (REARZ - 0.74);
  return g;
}
...
export function build() {
  ...
  for (const [x, z] of corners) {
    ...
    /* and the shell that rides with the wheel: the pant at the front, the
       saddle at the rear, both static */
    sys.add(front ? frontPantPart(s) : rearSaddlePart(s));
  }
