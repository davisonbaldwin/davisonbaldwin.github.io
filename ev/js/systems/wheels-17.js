  ...
  parts: {
    ...
    'front-pants': {
      ...
      specs: [
        ...
        ['Disc', '|z| 0.8255 outer face, r 0.373 about the axle, clipped at y 0.080 and notched at its trailing edge to x 1.115 below y 0.53, for battery-11\'s sill end at full lock; 16.0 mm off the tire section max, 14.5 off the cover lip, as wheels-13'],
...
const PANT = {
  ...
  Y0: 0.080,       // disc lower edge, above the road by 80 mm, carried
  TH: 0.004,       // laminate
  ARC_NOSE: 137,   // the nose cap reaches down to y 0.080 at x 1.704, the disc's own floor (wheels-13: 125, y 0.126)
...
const SADDLE = {
  ...
  ZOUT_END: 0.790, // Gen 15: and tapering to this over the last 15 degrees at each end, for the wall's blend and closure at 3 deg of rear steer (tools/envelope.sh: 1.8 and 4.9 mm at wheels-14's 0.8075)
  ...
  TH: 0.004,       // laminate
  ARC_NOSE: 65,    // ahead of the top: x -1.108, y 0.514, 18 mm behind body-13's shoulder panel end at -1.090
  ARC_TAIL: 75,    // behind the top: x -1.814, y 0.452, 86 mm ahead of the wall's closure at -1.900
...
function rearSaddlePart(s) {
  ...
  const zin = (deg) => {
    ...
    return SADDLE.ZIN + (SADDLE.ZIN_NOSE - SADDLE.ZIN) * t;
  };
  ...
  const zout = (deg) => {
    const t = deg >= 0 ? Math.max(0, (deg - 50) / 15) : Math.max(0, (-deg - 60) / 15);
