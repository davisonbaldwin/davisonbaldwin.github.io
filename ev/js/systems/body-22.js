...
export const SYSTEM = {
  ...
  closures: {
    ...
    hood: {
      ...
      kind: 'hood',
      part: 'skin',
      mass: 5.3,   /* Gen 22: 6.5 x 0.8097, the leaf's drawn area on this loft over body-21's (0.4743 m2 against 0.5858), tools measured: the front edge rides station 1 back */
      seconds: 1.2,
