...
const SPAT_TOP = 0.5200;      /* spat wall top, body-12's, KEPT after measuring.
...
export const SYSTEM = {
  ...
  closures: {
    door: {
      ...
      mass: 19,
      seconds: 1.6,
      seat: 'Deck shoulder at y 1.2380, axis along x at |z| 0.3685, inboard of the cage roof rail (body-12: 1.3030, the roof 65 mm lower)',
      motion: [
        { kind: 'swing', axis: [1, 0, 0], pivot: [0, 1.2380, 0.3685], deg: -50 },
      ],
    ...
    decklid: {
      ...
      motion: [
        { kind: 'swing', axis: [0, 0, 1], pivot: [-1.1600, 1.2570, 0], deg: -60 },
      ],
  ...
  parts: {
    ...
    'luggage-bay': {
      ...
      specs: [
        ...
        ['Floor', 'y 0.7750, x -2.500 to -1.170, 6 mm carbon sandwich, 35 mm over the rear casting\'s 0.740 and 11 over autonomy-13\'s compute plate at 0.764'],
...
const STATIONS = [
  ...
  /* 2  hood and frunk zone, x HELD; crown 0.960 to 0.940, 48 mm over the
        heat pump's 0.892 at x 1.79 to 2.05 */
  [2.030, [[0.310, 0.540], [0.390, 0.570], [0.470, 0.588], [0.560, 0.596],
           [0.700, 0.588], [0.810, 0.500], [0.895, 0.340], [0.927, 0.175]], 0.940],
  ...
  [0.300, [...SHLD,
           [0.955, 0.600], [1.125, 0.575], [1.230, 0.390], [1.254, 0.300]], 1.257],
  /* 9  maximum section, between the two occupants */
  [-0.450, [...SHLD,
            [0.975, 0.600], [1.145, 0.580], [1.230, 0.400], [1.254, 0.300]], 1.257],
  /* 10 rear shoulder closure, the aft end of the screw run and the flange */
  [-SHOULDER_X, [...SHLD,
            [0.955, 0.600], [1.135, 0.570], [1.228, 0.390], [1.254, 0.298]], 1.257],
  /* 11 rear arch, ARCH. The rear occupant's head is over this station */
  [-1.120, [...ARCH,
            [0.955, 0.600], [1.135, 0.570], [1.228, 0.390], [1.254, 0.298]], 1.257],
  /* 12 mid spat */
  [-1.280, [...ARCH,
            [0.945, 0.598], [1.115, 0.560], [1.193, 0.385], [1.217, 0.295]], 1.220],
  /* 13 rear axle */
  [-1.440, [...ARCH,
            [0.935, 0.590], [1.085, 0.545], [1.157, 0.375], [1.180, 0.290]], 1.183],
  /* 14 aft spat */
  [-1.620, [...ARCH,
            [0.915, 0.578], [1.050, 0.528], [1.115, 0.365], [1.138, 0.283]], 1.141],
...
function buildStructure(sys) {
  ...
  const members = [
    ...
    [0.024, [[-1.100, 1.227, 0.300], [-1.380, 1.123, 0.318],
  ...
  for (const bx of [0.300, -0.450, -1.100]) {
    cageMid.add(lib.tube([[bx, 1.2440, -0.260], [bx, 1.2440, 0.260]], 0.010, M.darkSteel));
  }
...
function buildShell(sys) {
  ...
  const BAY = { x0: -2.500, x1: -1.170, y: 0.7750, hz: 0.3300, h: 0.150 };
  ...
  for (const [tx, tz] of [[-2.40, -0.26], [-2.40, 0.26], [-1.30, -0.26], [-1.30, 0.26]]) {
  ...
  pillarKit.add(acbox(0.05, 0.028, 0.020, 0.004, M.sensor, 0.90, 0.915, 0.5880));
  pillarKit.add(acbox(0.09, 0.020, 0.012, 0.003, M.alu, 0.86, 0.915, Math.min(zc, 0.5940) - 0.004));
  sys.add(pillarKit);
