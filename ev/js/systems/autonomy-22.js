...
export const SYSTEM = {
  id: 'autonomy-22',
  name: 'Autonomy · Gen 22 the moved band',
  color: 0x6ea8ff,
  explode: [0, 2.3, 0],
...
export function build() {
  ...
  for (const s of [1, -1]) {
    ...
    bcam.position.set(0.780, 0.945, 0.4836 * s);   /* Gen 18: 27 mm inboard: at x 0.78 the belt is at y 0.895, the lens at 0.945 is in the tumblehome body-18 steepened, and the skin at its height is |z| 0.523 */   /* Gen 15: 37.4 mm inboard with body-15's flank */
    bp.add(bcam);
    ...
    for (const fx of [1, -1]) {
      ...
      pad.position.set(0.780 + fx * 0.013, 0.945, s * 0.5126);
      foot.add(pad);
      foot.add(screw([0.780 + fx * 0.013, 0.945, s * 0.5166], [0, 0, s], 0.0024, M.steel));
    }
    bp.add(foot);
    sys.add(bp);
  }
