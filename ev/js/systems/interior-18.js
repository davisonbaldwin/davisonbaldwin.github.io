/* INTERIOR-18: ONE SEAT. interior-15 with the rear shell seat, its belts, its
   thorax bags and its repeater gone, the liner and the curtain following
   body-18's roof down behind the single head, and the space behind the seat
   given a bulkhead, a floor liner and four rings as the well the car's
   luggage now goes in. design/gen18.md sections 2 and 6; the capability cost
   is stated there and again in the blurb: the car carries one person.

   What does not move: the front shell seat at H-point (0.425, 0.342, 0) and
   36 degrees, the cowl beam and fascia, the yoke, the pedals, the NVH package
   over the occupant. The occupant tool reads ONE declared occupant from this
   module. Everything below this block is interior-15's own record, kept
   whole, because the cabin in front of the bulkhead is interior-15's. */
...
export const SYSTEM = {
  ...
  parts: {
    ...
    displays: {
      ...
      mass: 6.5,    /* Gen 18: the repeater strip and its driver are gone */
      specs: [
        ...
        ['Rear repeater', 'Gone (Gen 18): there is no rear occupant'],
    ...
    'luggage-well': {
      name: 'Luggage well and bulkhead',
      tagline: 'The space the rear seat stood in, behind the only occupant: a structural bulkhead, a floor on the pack lid and four rings, loaded through the hatch.',
      mass: 5.5,
      specs: [
        ['Floor', 'battery-17\'s lid (rail tops at y 0.308), x -0.60 to -1.17 between the sill heads at |z| 0.66; the mat covers -0.605 to -0.835, ahead of suspension-17\'s chassis ECU (x -0.844 to -1.061, 36 mm tall) and hv\'s rear drops, which sit on the lid at the well\'s aft end'],
        ['Bulkhead', '4 mm carbon sandwich at x -0.600: a 280 mm center strip from the rail tops to 0.58, then full width (1.00 m) to 1.06; a 100 by 280 mm grommeted pass-through for the glycol loop at (0.81, -0.17); the sill corridors under 0.58 open'],
        ['Rings', 'Four, on the lid\'s rail tops at x -0.66 and -0.80, |z| 0.28'],
        ['Ceiling', 'body-18\'s roof, 1.15 m at the bulkhead falling to 1.05 at the bay bulkhead'],
        ['Volume', '397 liters of enclosed free air behind the bulkhead, x -0.60 to -1.17, swept at 20 mm against every module of the gen18 set; the largest clear box 420 by 480 by 720 mm, 145 liters, at x -1.05 to -0.63 over y 0.38 to 0.86 (body-17\'s bay: 250 and a 105 liter box 160 mm tall)'],
      ],
      how: 'The well is what the second seat leaves behind. Its floor is the pack lid the seat stood on, its walls are the cabin\'s own sills and skin, its ceiling is the roof body-18 brings down from the single head, and its forward wall is the one piece drawn here that carries a load: a 4 mm carbon sandwich bulkhead at x -0.600, spanning the cabin from the lid to the liner, because body-17\'s bay panel named the question this answers (20 kg of luggage behind a head at 30 g is a bulkhead question and the bulkhead drawn there was 4 mm of liner, not structure). This one lands on the sill flanges each side and on the lid, and the seat back stands 0.43 m ahead of it. A floor mat over the lid\'s NVH tiles, four rings on the rail tops battery-17 already provides, and a liner over the bulkhead\'s cabin face are the rest. 5.5 kg: 4.0 the bulkhead by its area at 4 kg per square meter, 1.0 the mat, 0.5 the rings and liner.\n\nThe volume is swept, not asserted, the way body-12 and body-16 swept the bay: the region x -1.17 to -0.604, y 0.30 to 1.15, |z| 0.64 voxelized at 20 mm against every triangle the gen18 preset builds, every triangle marking every voxel its bounding box touches. Enclosed free air: 397 liters. The largest axis-aligned box with nothing in it: 420 by 480 by 720 mm, 145 liters, from x -1.05 to -0.63 over y 0.38 to 0.86, which sits above the chassis ECU and the drops on the lid and is a suitcase standing on end, not a ski bag. body-17\'s bay measured 250 liters and a 105 liter box 160 mm tall under the descending tail; that bay is shorter now and the well is where the luggage goes.',
      why: 'A tandem car booked the loss of a four-seat car\'s rear volume at Gen 11 and body-12 and 16 put a shelf in the tail against it. A one-seat car gets the better trade: the volume behind the seat is taller than the shelf was and it is inside the cabin\'s own structure, so it needs a bulkhead and nothing else.',
      fail: [
        'The bulkhead is sized by an argument, not a test: 4 mm sandwich at 1.2 by 0.85 m against a 6 kN load is comfortable, but nothing here models the sill flange joint it lands on.',
        'The well is loaded through the hatch, which means lifting over the rear quarter: the sill is at 0.42 and the hatch lip higher. It is a trunk, not a tailgate.',
        'The two sill corridors under y 0.58 are open, because every fore-aft run on the car passes there: something small and low can slide forward under the panel into the footwell. The rings are the restraint for what is low.',
        'The aft 330 mm of the well floor is not floor: suspension-17\'s chassis ECU and hv\'s rear drops sit on the lid there, uncovered, where the rear seat used to stand over them. A cover over them is a part nobody has drawn, and the clear floor ahead of them is 230 mm long.',
      ],
    },
    pedals: {
      name: 'Pedal set',
    ...
    'canopy-liner': {
      ...
      mass: 3.5,    /* Gen 18: the liner ends at -0.70 instead of -1.06 and follows the roof */
      specs: [
    ...
    nvh: {
      ...
      mass: 4.5,    /* Gen 18: the rear transducers and the aft microphones are gone */
      specs: [
    ...
    restraints: {
      ...
      mass: 4,      /* Gen 18: one lap and shoulder set, its pretensioners and bags; the rear set and the aft thorax pair are gone; the curtain shorter */
      specs: [
...
function buildSeat(g, hx, feet, sideX, front) {
  ...
  /* Gen 18: no repeater strip in the back shell; there is nobody to read it */
}
...
export function build() {
  ...
  /* ── rear seat: NONE. Gen 18 carries one occupant; the space is the well below. ── */
  ...
  /* ── THE WELL, Gen 18: the space behind the seat ─────────────────────── */
  const well = lib.part('luggage-well', [-0.85, 0.55, 0]);
  {
    /* the bulkhead: 4 mm sandwich at x -0.600 from the lid to under the
       roof (body-18's crown at -0.60 is about 1.17; the panel stops at 1.12
       under the liner's line), between the sill heads at |z| 0.66 below the
       shoulder and the flank above it: drawn as a trapezoid, wide at the
       floor and narrow at the top, so it stays inside the skin */
    /* The panel is T-shaped, and the shape is the service corridor's. Every
       fore-aft run on this car passes x -0.60 along the sills under y 0.50:
       the sensor ring at (0.36, |z| 0.49), the air supply at (0.41, 0.18),
       hv's runs at (0.445, 0.59) and feeds at (0.45, 0.57), the recovery
       core at the flank to 0.57. A full panel cut all of them. So the lower
       300 mm is a 280 mm wide center strip between the inner rails, and the
       full-width panel starts at y 0.58, inside the skin by 60 mm at the
       shoulder (the flank is 0.56 vertical to 0.91 at this x) and following
       the tumblehome in to 0.30 at its top, 1.06, under the roof rail at
       0.28 to 0.32 by 50 mm. thermal-17's glycol loop to the compute plate
       crosses at (0.81, -0.17): a 100 by 280 mm pass-through, grommeted. The
       two sill corridors under 0.58 are open; the rings restrain what is
       low, and the panel says so. */
    const bh = new THREE.Shape();
    bh.moveTo(-0.140, RAILY + 0.004); bh.lineTo(0.140, RAILY + 0.004); bh.lineTo(0.140, 0.580);
    bh.lineTo(0.500, 0.580); bh.lineTo(0.500, 0.880); bh.lineTo(0.460, 0.920); bh.lineTo(0.400, 0.980);
    bh.lineTo(0.300, 1.060); bh.lineTo(-0.300, 1.060); bh.lineTo(-0.400, 0.980); bh.lineTo(-0.460, 0.920);
    bh.lineTo(-0.500, 0.880); bh.lineTo(-0.500, 0.580); bh.lineTo(-0.140, 0.580); bh.closePath();
    /* the pass-through for the glycol loop, a hole in the shape */
    const hole = new THREE.Path();
    hole.moveTo(-0.120, 0.760); hole.lineTo(-0.220, 0.760); hole.lineTo(-0.220, 0.860); hole.lineTo(-0.120, 0.860); hole.closePath();
    bh.holes.push(hole);
    const bg = new THREE.ExtrudeGeometry(bh, { depth: 0.004, bevelEnabled: false, steps: 1 });
    const bulk = lib.mesh(bg, M.carbon);
    bulk.rotation.y = Math.PI / 2;           /* the shape's x becomes z, its extrusion runs along x */
    bulk.position.set(-0.600, 0, 0);
    well.add(bulk);
    /* a fabric liner on the bulkhead's cabin face */
    well.add(abox(0.004, 0.30, 0.96, M.fabric, -0.5955, 0.73, 0));   /* over the full-width panel's vertical part only, y 0.58 to 0.88 */
    /* the floor mat on the lid, and four rings on battery-17's rail tops */
    well.add(abox(0.230, 0.006, 1.10, M.rubber, -0.7200, RAILY + 0.003, 0));   /* x -0.605 to -0.835, to |z| 0.55: suspension-17's chassis ECU sits on the lid at x -0.844 to -1.061 (36 mm tall) and hv-15's rear drops behind it, so the mat stops ahead of them; inside the air supply at 0.60 */   /* on the lid's rail-top plane, 0.308, not the 0.302 skin: battery-17's lid is 17 mm thick to 0.308 */
    for (const [rx, rz] of [[-0.66, -0.28], [-0.66, 0.28], [-0.80, -0.28], [-0.80, 0.28]]) {   /* ahead of the ECU at -0.844 */
      const ring = lib.torus(0.016, 0.004, M.steel, 16, 8);
      ring.rotation.x = Math.PI / 2;
      ring.position.set(rx, RAILY + 0.004, rz);
      well.add(ring);
    }
  }
  sys.add(well);
  ...
  const lin = lib.part('canopy-liner', [0, 0.55, 0]);
  {
    ...
    /* Gen 18: the liner follows body-18's roof, 24 mm under the crown as
       1.2330 was under 1.2570 (skin 1.257, bow soffit 1.234, liner 1.233),
       and ends at x -0.70, behind the single crown at -0.14 and the head bow
       at -0.45; there is no rear head to carry it further. The heights are
       the built crown of body-18 at each station less 0.024: flat to -0.35,
       1.2336 at -0.42, 1.140 at -0.70 (design/gen18.md 4b, the ramp). */
    const ST = [
      [0.240, LINER, 0.210],
      [0.100, LINER, 0.220],
      [-0.140, LINER, 0.230],
    ...
    for (const [x, y, ch] of [[0.250, 1.2390, 0.018], [-0.440, 1.1960, 0.010]]) {   /* Gen 18: the aft clip rail under the head bow at -0.45, whose bottom is 1.2010; rail top 1.2000, clips to it */
      lin.add(abox(0.028, 0.008, 0.380, M.alu, x, y, 0));
      for (const s of [-1, 1]) lin.add(abox(0.026, ch, 0.024, M.darkSteel, x, y + (ch === 0.018 ? 0.002 : -0.0005), s * 0.150));
    }
    /* two ceiling lights and the swept-cavity extract collar */
    for (const x of [-0.060]) {   /* Gen 18: one lamp over the one occupant */
    ...
    /* Gen 18: the extract collar moves to the liner's aft edge, under the
       roof at -0.70 (1.140 crown); thermal-17's extract path is re-checked */
    const col = lib.tube([[-0.660, 1.1060, 0.140], [-0.684, 1.0920, 0.180],
                          [-0.700, 1.0580, 0.200]], 0.022, M.plasticLt);
    lin.add(col);
  }
  sys.add(lin);
  ...
  const nvh = lib.part('nvh', [0, -0.35, 0]);
  {
    ...
    /* two headrest transducers, one occupant (Gen 18) */
    for (const hx of [HIPF]) {
      for (const s of [-1, 1]) {
    ...
    /* four microphones on the liner longeron line (Gen 18: the aft pair went with the rear head) */
    for (const x of [0.180, -0.140]) {
      for (const s of [-1, 1]) {
  ...
  {
    for (const hx of [HIPF]) {   /* Gen 18: one set */
    ...
    /* Gen 18: no aft thorax pair; nobody sits behind the seat back. The
       curtain covers the one aperture, x 0.37 to -0.45, and comes in to
       |z| 0.36 because the belt seam is at 0.46 and the tumblehome at y
       1.135 passes |z| 0.384 at x -0.45 (body-18's stations); 11 mm inside. */
    for (const s of [-1, 1]) {
      res.add(abox(0.820, 0.040, 0.026, M.fabric, -0.040, 1.1350, s * 0.3600));
    }
  }
  sys.add(res);
