...
function buildShell(sys) {
  ...
  const SPAT = [
    ...
    [-1.030, 0.7800, 0.4600], [-1.095, 0.7955, SPAT_TOP], [-1.440, 0.7955, SPAT_TOP],
    ...
    [-1.780, 0.7955, SPAT_TOP], [-1.900, 0.7920, SPAT_TOP - 0.010, 0.7800], [-2.060, 0.7500, SPAT_TOP - 0.030, 0.6000], [-2.250, 0.6400, SPAT_TOP - 0.060, 0.5100], [-2.400, 0.5300, SPAT_TOP - 0.085, 0.4650],
  ];
  for (const side of [-1, 1]) {
    ...
    spats.add(acbox(0.90, 0.003, 0.012, 0.0015, M.carbon, -1.50, 0.1815, side * 0.7895));
  }
  sys.add(spats);
