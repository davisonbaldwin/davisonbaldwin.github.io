/* Thermal, Gen 7 range. The generation optimises miles, and this slot owns
   ...
   - Floor 4.35 m2 at U 0.8, because battery-6's lid is carbon over aramid
     ...
     below the aluminium panel it replaced.
   ...
   - body-7 (built): loft stations read directly. Its bonnet over the front
     ...
     to draw a 43 degree bonnet leading edge to clear it. The tallest thing
     this module leaves in that stack is the refrigerant distributor at
     y 0.528, and the tightest bonnet clearance anywhere over the stack is
   ...
   - body-7 arch louvers: outlet bank at x 1.100..1.286, y 0.45..0.55 on the
...
export const SYSTEM = {
  ...
  parts: {
    'outdoor-coil': {
      ...
      tagline: 'It got deeper instead of taller, because body-7 had to draw a 43 degree bonnet leading edge over where thermal-6 put its header and the pack stopped needing the height.',
      mass: 10,
      specs: [
        ['Rows', 'Glycol y 0.285 to 0.400, refrigerant y 0.427 to 0.497, one frame'],
        ['Face', '0.091 and 0.055 m², both 70 mm deep, 1.2 mm louvred fin pitch'],
      ...
      how: 'A heat pump is only as good as the temperature it can find outside, and what stands between the refrigerant and the ambient air is this coil\'s approach temperature. Every kelvin of approach is a kelvin the compressor has to lift that nature was offering free, worth about 3 percent of COP each on the reference night. thermal-6 ran an 11 K approach because its condenser was sized for a 25 kW condensing duty on a 40 °C afternoon and nothing else mattered. The refrigerant row here carries 1 to 3 kW and is sized for approach rather than for capacity: 70 mm of depth, a 1.2 mm louvred fin pitch and a face velocity near 2.5 m/s where thermal-6 ran 6, which buys 6 K. Under this project\'s premise a heat exchanger is allowed to be extravagant, and extravagance in a coil means slow air over a great deal of surface.\n\nThe shape is not a free choice, and every reason is a partner. body-7\'s intake gates admit air through four slats spanning y 0.19 to 0.384 at |z| up to 0.40, which is the whole aperture this car has. Its bonnet over the front zone runs y 0.849 at (x 2.14, |z| 0.40). Its bumper beam occupies x 2.210 to 2.270, which thermal-6\'s core overlapped by 7.5 mm and body-7 recorded as a carried condition. thermal-6 stacked its condenser at y 0.44 to 0.74 to win the gravity head its thermosiphon needed, which put its inlet header at y 0.770 and forced body-7 to draw a 43 degree bonnet leading edge over it, a pedestrian-zone bill body-7 lists on its own skin panel. None of that is needed now, because the pack condenses into the glycol row rather than into air. Both rows drop into the band the gates actually feed, the core plane moves aft to x 2.168 so the beam overlap goes away, and the tallest thing this module leaves in the front stack is the refrigerant distributor at y 0.528, which clears the bonnet by 311 mm at the tightest station over the stack. The plenum spreads the gate flow 116 mm instead of turning it up 356, and thermal-6\'s two turning vanes go with it.',
    ...
    'heat-pump': {
      ...
      mass: 10,
      specs: [
        ['Machine', 'Economised two-stage scroll with vapor injection, 900 to 9,000 rpm'],
    ...
    'air-handler': {
      ...
      tagline: 'The air side stops being the heater and becomes what it should always have been: ventilation, demist, and one damper that decides whether interior-6\'s ceiling gap insulates or breathes.',
      mass: 7,
      specs: [
      ...
      fail: [
        'Demist authority is the floor under every number on this panel. A 16 °C cabin holds less moisture but its glass also runs colder, so the dew point margin is not obviously better, and the blower cannot go below about 180 m³/h with the dehumidify coil live without losing the windscreen. That is why the 4 °C branch survives into a system whose whole argument is that it stopped lifting far, and it is the one duty that still runs the compressor at a bad COP.',
    ...
    'recovery-core': {
      ...
      tagline: 'Ninety cubic metres an hour of fresh air is 513 watts thrown out of the window at 4 °C, and in seven generations nobody has asked for any of it back.',
      mass: 4,
      specs: [
...
/* ── Geometry ──────────────────────────────────────────────────────────────
   ...
   y 0.875 and clears the bonnet by 36 mm at (1.989, z -0.258). Nothing in
...
const GY = 0.3425;         /* glycol row centre: y 0.285..0.400 */
const RY = 0.4620;         /* refrigerant row centre: y 0.427..0.497 */
...
export function build() {
  ...
  /* economiser flash vessel and its plate stack */
  ...
  /* ── ventilation recovery core: counterflow membrane stack under the case
     ...
     cabin return grille, the cowl fresh-air riser, a motorised bypass, and
     the exhaust that pierces body-7's fairing inner wall at |z| 0.693..0.707
     to discharge into the arch just aft of its outlet louver bank ── */
  ...
  /* exhaust out through the fairing wall into the arch */
  rec.add(lib.tube([
    [0.958, 0.452, 0.375],
    [0.992, 0.462, 0.470],
    [1.018, 0.472, 0.590],
