/* Gen 5 body: the design-to-cost Kammback. The Gen 2 aero silhouette
   ...
   roof where the glass canopy was, a fixed molded intake in place of the
...
export const SYSTEM = {
  ...
  parts: {
    ...
    skin: {
      ...
      how: 'The lines are body-aero\'s, unmoved: nose tip at (2.30, 0.72), cowl at (1.05, 0.92), Kamm face at x -2.28, half-width 0.94 at the doors, and the 4 to 8 degree boat-tail in plan. What changed is under the paint. Aero cares about shape and surface continuity; it cannot tell 0.68 mm of galvanized steel from 0.9 mm of AA6016, so the substrate switches to the metal that costs a quarter as much per kilogram and forms in any press shop on earth. The side regroups into two large draws, fender and bodyside, where body-aero bonded four panels a side: fewer flanges, fewer bond lines, fewer fixtures, and a die bill 8 to 12 million dollars lighter because four die sets are never cut.\n\nThe rear arches are the visible deletion. body-aero skirted them for 0.010 of Cd; this shell opens them and surrenders those ten counts, because in fleet service a skirt is a consumable: curbed rims throw wheel weights against it, tire bays remove it wrong, roadside assistance pries it, and every event is an 80 dollar panel plus a day off the road. The honest ledger both ways: steel adds 12 kg here while the deleted aero devices give about 20 kg back across the shell, which is how the whole car sits only 7 kg over the aero shell at 377, and the ten counts cost 2 to 3 percent of consumption at highway speed but under 1 percent at the 25 km/h average this car is bought for. Sheet steel alone gives roughly 200 dollars a car back before the tooling is counted.',
      why: 'Two cars can both be correct. body-aero spends process to buy counts because it is the optimization argument; this shell spends counts to buy process because it is the economics argument. Steel where aero does not care, aluminum and glass only where it does, and the silhouette, the one thing the wind actually audits, carried unchanged.',
      fail: [
        'Steel rusts where aluminum chalked: every hem, cut edge, and stone chip is a corrosion clock, and the galvanize plus seam sealer are doing work body-aero never asked of them.',
        'Large shallow steel draws oil-can; the deck carries mastic pads, and a skipped pad drums at highway speed exactly as body.js warned for its own deck.',
    ...
    roof: {
      ...
      tagline: 'The canopy\'s center facet in 0.65 mm steel: the same line over the cabin, none of the sky.',
      mass: 12,
      specs: [
    ...
    glazing: {
      ...
      specs: [
        ...
        ['Replacement', 'A 500 dollar windshield vs condemning a canopy'],
      ],
      how: 'Both panes sit on the canopy\'s own facet angles: the windshield runs the cowl line from (1.05, 0.92) to the peak at (0.15, 1.38), the backlight falls from (-0.75, 1.31) to (-1.70, 0.97). The windshield keeps the full body-aero stack, acoustic PVB and the optical camera zone included, because the 63 degree rake and the ADAS camera are carried and physics does not discount. The backlight drops to tempered: no acoustic duty at the tail, no camera looking through it, and a rescue tool needs one pane it can actually shatter, the same honest argument body.js made for rear side glass.\n\nSeparation is the economics. A windshield is the most replaced panel on any fleet car; stone chips retire them on a schedule measured in one or two hundred thousand kilometers. Standalone, that event is a 500 dollar pane and a camera recalibration; fused into a canopy it meant condemning the most expensive panel on the car, which body-aero\'s own fail list conceded. The tempered backlight is a 150 dollar part. Two ordinary sag-formed panes also delete the cell-cast tooling: no 620 degree precision molds, no three-facet lamination, just glass any supplier quotes from a catalog.',
      ...
      fail: [
        ...
        'Every windshield swap forces ADAS recalibration, and a fleet does many; the half-degree-equals-meters warning from body.js is a depot procedure here, not a footnote.',
      ],
      explode: [0.5, 0.65, 0],
    },
    nose: {
      ...
      fail: [
        'A steel hood marks in hail and under careless palms, same physics as body.js\'s aluminum but cheaper per repaint, which is the fleet consolation.',
        'Steel bolted to the aluminum casting is a galvanic couple at every fastener; isolation washers carry over from the structure\'s own warranty list.',
        'No splitter means crosswind and truck-wake composure at highway speed sits a shade below body-aero; under 80 km/h no driver will feel it, and above it the honest answer is that the flagship exists.',
      ],
      explode: [1.05, 0.12, 0],
    },
    intake: {
      name: 'Fixed molded intake',
      tagline: 'One glass-filled molding where five slats cycled: nothing to jam, seize, ice, or replace.',
      mass: 1,
      specs: [
    ...
    cladding: {
      name: 'TPO cladding',
      tagline: 'Molded-in black on every surface the fleet actually hits: paint is a cost per square meter, and bumpers meet the world.',
      mass: 12,
      specs: [
        ['Material', 'TPO, 2.5 to 3.0 mm, color molded in'],
        ...
        ['Rear ramp', 'Molded upsweep in the valance; vaned diffuser deleted'],
        ['Repair', 'A scuff sands out; a panel swaps for 60 to 90 dollars'],
      ],
      how: 'Same polymer as body.js\'s fascias, minus the paint shop. Painting TPO needs an adhesion promoter, a color-matched base, a clear coat, and a paint-line slot, 60 to 100 dollars per car across both ends, and the result ages apart from the metal it neighbors, as body.js\'s own fail list admits. Molded-in black needs none of it, hides scuffs in its own color to full depth, and turns the most-hit panels on the car into the cheapest per event. The rockers get the same treatment because they live in the stone and curb blast; painted metal there would be chipped to primer in a fleet year.\n\nThe rear valance carries the underbody\'s exit. body-aero bolted a 7 kg vaned carbon diffuser and earned real counts from a 13 degree ramp near the separation limit; this valance molds a shallower upsweep into the same TPO piece for nothing, keeps most of the flat floor\'s pressure recovery, and gives back about 2 counts against the vaned version. It also deletes the diffuser\'s failure modes wholesale: no bolt-on carbon at the lowest rear point of the car, no driveway-rake sacrifices, no vanes to stall. The air-curtain slots for the front wheels are molded into the front fascia the same way, plain ducts doing the splitter\'s tidying job at zero part count.',
      why: 'Separating the elastic cheap skin from the structure is one of the oldest good ideas in car design, and body.js said so; Gen 5 just refuses to paint it. On a car bought per kilometer, cladding is priced per incident, and molded-in black is the lowest number that field has ever produced.',
      fail: [
        'Unpainted TPO chalks gray over years of UV; on a fleet car that reads as honest wear, on a driveway it reads as cheap, and this car knows which customer it has.',
        'A deep gouge shows white and stays; sanding hides scuffs, not gashes, and the answer is the 60 to 90 dollar panel.',
        'The molded ramp is tuned once for one ride height; it is 2 counts short of the vaned diffuser on its best day and it has no best day, only average ones.',
      ],
      explode: [1.15, -0.05, 0],
    },
    doors: {
      ...
      fail: [
        ...
        'Steel hems rust from the inside if the sealer skips a beat; body-aero\'s bonded aluminum never had the failure, and galvanize is the mitigation, not the cure.',
    ...
    lamps: {
      ...
      specs: [
        ...
        ['Rear', '2 LED modules: tail, brake, turn signal'],
        ...
        ['Aim', 'Screw adjusters at service; no leveling ECU'],
      ],
      how: 'Each front module is a single projector LED behind a plain lens in a sealed rectangular housing: 1,300 lumen low beam, a binary high beam, screw-set aim, and enough housing volume that a simple finned heatsink cools it without the thermal gymnastics body.js described for slim strips. The 84 pixel matrix is deleted along with its camera link and pixel controller: regulations price photometry, glare, and aim, not signature, and a rectangle passes the same tables the blade did.\n\nThe rear pair keeps what physics gives for free, sub-10 ms brake rise and software photometry for EU and US markets, and deletes the meter-long PMMA light guide whose uniformity was a tooling project in itself. The fleet argument is the parts book: body-aero\'s own fail list admits a parking tap that would have cost one lamp costs the whole strip, and corner taps are the most frequent claim in urban fleet service. Four independent 60 to 90 dollar modules stock in a depot drawer, swap in minutes from outside, and never total a bumper\'s worth of lighting in one event.',
      ...
      fail: [
        ...
        'No auto-leveling means a loaded car aims high until the service screw is set; the depot checks it at tire rotations.',
...
/* ── Geometry ──────────────────────────────────────────────────────────────
   ...
   cowl (1.05, 0.92), canopy peak (0.15, 1.38) now split windshield / steel
...
export function build() {
  ...
  /* ── roof: painted steel panel on the canopy's center facet, two bows ── */
  ...
  /* ── glazing: windshield and backlight on the canopy facet angles ── */
  ...
  /* ── fixed molded intake: frame, three fixed vanes, short sealed duct
  ...
  /* molded upsweep ramp in the valance: the vaned diffuser's cheap heir */
