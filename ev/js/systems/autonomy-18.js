...
export const SYSTEM = {
  id: 'autonomy-18',
  name: 'Autonomy · Gen 18 re-seated on the single-seat roof',
  color: 0x6ea8ff,
  explode: [0, 2.3, 0],
...
export function build() {
  ...
  rc.position.set(-2.658, 0.600, 0);   /* Gen 18: the face's upper section closes at 0.66 */
  camRear.add(rc);
  ...
  nozBody.position.set(-2.6505, 0.6205, 0.022);
  camRear.add(nozBody);
  const noz = lib.cyl(0.0022, 0.011, M.plasticLt, 8);
  noz.rotation.z = Math.PI / 2;
  noz.position.set(-2.6620, 0.6205, 0.022);
  camRear.add(noz);
  sys.add(camRear);
