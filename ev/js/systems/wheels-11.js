/* Wheels and brakes, Gen 11: the corner does not move, the harness does.
   ...
   measured against what the preset builds or is labelled as history.
   ...
   cabin floor to the toeboard plane forward of body-11's pan. No tyre, wheel,
   ...
   delta of exactly zero. The tyre column
   ...
   module builds no tyre and moves no tread, so it has even less to say: Crr
...
export const CRR_BASIS = {
  ...
  counts: [
    ...
    ['wheels-11', 0.0038, 'CARRIED AGAIN, and this rung has less claim on the number than any before it: it builds no tyre. Rolling drag is Crr times weight, a harness route is neither, and design/gen11.md section 8 declines a Crr credit for three wheels on the same argument'],
  ],
...
export const SYSTEM = {
  ...
  /* Mating features other modules have to land on. Schema in SPEC.md;
     ...
     declarer states for agreement and each declarer's OWN for realisation,
     so this module keeps 11 mm: its nearest tyre vertex is 10.0 mm off the
  ...
  interfaces: {
    ...
    /* THE FRONT CORNER, declared because design/gen10.md hard point 3 asks
       ...
       nothing about it, because fixing it means moving a tyre. The discs
...
/* ── Brake-by-wire unit ──
   ...
   section reads
     ...
     |z| 0.6400   THE NEW CORRIDOR CENTRELINE, both runs                 <-
     |z| 0.6443   harness outer skin. NOT 0.6435: the centreline is a
...
function masterUnitPart() {
  ...
  /* Aft harnesses: park-brake commands plus the brake-priority arbitration
     ...
     parent to a tenth of a millimetre. 128 more triangles. */
  const aftL = [
    [0.920, 0.570, -0.380],
    [0.870, 0.500, -0.480],
    [0.800, 0.430, -0.570],
...
/* ── THE GATE ─────────────────────────────────────────────────────────────
   ...
   termination and both on a centreline that did not move; the fail list
