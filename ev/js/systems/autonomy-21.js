...
export const SYSTEM = {
  id: 'autonomy-21',
  name: 'Autonomy · Gen 21 the ring ahead of the wheel',
  color: 0x6ea8ff,
  explode: [0, 2.3, 0],
...
export function build() {
  ...
  for (const s of [1, -1]) {
    ...
    /* Rear corner strut, outboard to body-11's tail cone. Its inner surface
       ...
       -2.309, 0.33 m of |z| per meter of x. A 49 mm strut reaching 0.4492 was
