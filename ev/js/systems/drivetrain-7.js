/* Drive units, Gen 7: range. This module exists to answer one question,
   ...
   - rear wheel centers (-1.45, 0.355, +/-0.74); front unchanged at +/-0.81
   ...
   there too: halfshaft centers at |z| 0.520, joint center 0.215 out, joint
   ...
   swings it about the wheel center. Swept, its inboard face reaches
   ...
   battery-7's shipped geometry. Moving the rear centers 70 mm inboard
...
export const SYSTEM = {
  ...
  interfaces: {
    'front-halfshaft-outboard': {
      ...
      note: 'outboard CV joint face. Shaft centers at |z| 0.52, joint center 0.215 out, joint 55 mm long, so the face lands on 0.7625.',
    },
  },
  parts: {
    'stator-rings': {
    ...
    'rotor-rings': {
      ...
      specs: [
        ...
        ['New center', '|z| 0.74, was 0.81; rear track 1.48 m, was 1.62'],
    ...
    'hub-bearings': {
      ...
      fail: [
        ...
        'Every suspension-4 number above is measured against a file that everyone already agrees is out of date, so it describes today\'s model rather than tomorrow\'s axle. It is quoted anyway, because design/retro-gen4.md says a partner claim gets verified rather than inherited, and because the alternative is to say that the tightest thing the relocated corner created was a 12 mm gap, which is not so. It was not a gap. It was 23 mm of overlap, and nobody would have found it by reading.',
      ],
      explode: [0, 0, 0.78],
    },
    'corner-inverters': {
...
/* NEW rear wheel center |z|. P.wheelZ (0.81) still governs the FRONT axle;
   design/gen7.md moves the rear centers to 0.74 and this module and
...
function statorRingPart(s) {
  ...
  /* yoke r 0.174..0.181, |z| 0.655..0.725. Seven millimeters because 32
...
function frontUnitPart() {
  ...
  /* printed load-path ribs, following the optimizer's spider */
  for (let i = 0; i < 7; i++) {
    const a = 0.35 + i * 0.82;
  ...
  /* both front halfshafts, spinning, in this part's 38 kg.
     ...
     center 215 mm out, so its outboard face lands on |z| 0.7625, which is
