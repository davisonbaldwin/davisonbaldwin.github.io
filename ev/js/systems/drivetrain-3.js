/* Drive units, generation 3: in-wheel motors, attempted honestly. The rear
   ...
   wheel centers. Rear-corner part groups explode z-outward at magnitude
...
export const SYSTEM = {
  ...
  parts: {
    'stator-rings': {
      ...
      tagline: 'The gearbox is gone, so every newton-meter is made at full price: 15 kg of ring per corner, working at the rim.',
      mass: 30,
      count: 2,
      specs: [
      ...
      fail: [
        'The motor lives where brakes live: road spray, winter salt, pressure-washer lances at 80 bar. Its first line of defense is the hub bearing seal, and a failed lip seal now floods a stator instead of wetting a drum.',
        'Zero-speed full torque is the thermal worst case, and it happens on driveways: the derate that protects one overworked coil arrives exactly when a driver is holding the car against a curb ramp with a trailer on.',
        'Torque ripple lands directly on the unsprung mass with no gear mesh or halfshaft compliance to filter it; the 18-slot 20-pole combination is chosen for low cogging, and what remains is canceled by injection, per corner, forever.',
      ],
      explode: [0, 0, 0.97],
    },
    'rotor-rings': {
      ...
      fail: [
        'The wheels-3 park-and-rescue drum lives inside this ring, and a dragged rescue stop is a heat source millimeters from magnets; the corner controller trades braking to the front friction discs when magnet temperature models approach the demagnetization knee.',
    ...
    'hub-bearings': {
      ...
      fail: [
        ...
        'The grounding ring is a wear part in a place nobody looks; when its fibers wear or its track dries, inverter common-mode current returns to the path of least resistance, which is the race the ring existed to protect.',
    ...
    'service-loops': {
      ...
      fail: [
        ...
        'EPDM stiffens toward -30 °C and the effective bend radius tightens; the first kilometers of a cold morning are the highest-strain cycles of the loop\'s life, and the fatigue model books them at triple weight.',
      ],
      explode: [0, 0, 0.85],
    },
    'tv-controller': {
    ...
    'front-unit': {
      ...
      fail: [
        ...
        'The relocated oil pan baffle is the one internal change, which makes it the one unproven component inside a twice-proven unit; oil starvation under combined braking and cornering is the case the rig week was bought for.',
...
const RING_Z = 0.76;            // motor annulus center plane, |z|
...
function hubBearingPart(s) {
  ...
  g.add(sleeve);
  /* stud flange rides the rotating race: own origin-centered group on the
