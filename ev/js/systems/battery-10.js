/* Gen 10 battery: battery-7's pack with its outboard front corner cut away
   ...
   1. The lid does NOT reach |z| 0.744 at this corner. 0.7440 is the
      ...
      before the tyre's plan circle begins. Sliced at the stations where the
      tyre actually is, the pack's outboard surface is 0.7100 (lid panel)
   ...
   2. So the track figure moves with it. Clearing 0.7100 with a 155 mm
      casing needs the front centre at |z| 0.7875, not past 0.82. That is
   ...
   3. The 43 brick vertices outboard of the tyre plane are not cells and
      ...
      of them at x 1.2371 to 1.2596, which is inside the front tyre. This
      ...
      the front tyre, surface to surface on the same method every clearance
   ...
   percent, and 43 beyond the tyre plane, which is 0.117 percent, in a
   ...
   outboard face is |z| 0.6500 to 24 nanometres and that is the plane this
   ...
   depth is set by the CELL STACK and not by the tyre: the layers are
   ...
   on the chamfer at (1.0909, 0.3020, 0.6860) against the tyre's inner
   shoulder at (1.1005, 0.3039, 0.6904), where the tyre's plan circle first
   reaches lid height. At the notch face proper the tyre's sidewall plane is
   ...
   on, a point on the tyre swings inboard at the rate of its LONGITUDINAL
   offset from that axis, 1.45 less x, and not at the rate of its radius.
   The tyre's aft-most vertex is x 1.0950 on both wheels, an offset of
   ...
   earlier draft of this file credited the notch with something the tyre
   ...
   every further millimetre is layer width, which is energy. The fix belongs
   ...
   - wheels-10: built front tyre inner sidewall |z| 0.6725, ten millimetres
     OUTBOARD of wheels-9's 0.6625 because the section goes 155 to 135 on
     an unmoved 0.740 centre. Its brake disc is unchanged and its inner
     face is |z| 0.6040, reaching floor-lid height from x 1.2754. The notch is
     sized on the cell stack rather than on either tyre, so it holds for
   ...
   a moulded wall standing in a boiling fluoroketone bath. At
