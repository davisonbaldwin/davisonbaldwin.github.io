...
export const SYSTEM = {
  ...
  parts: {
    tires: {
      name: 'Tires',
      tagline: 'Three tires, two drawings: 125/81 R20 on the axle that carries the roll couple, one 155/65 R20 on the patch no couple can reach, both at 5.6 bar, both deflections inside the class the carried crr rode on.',
      mass: 21.0,
      count: 3,
      specs: [
        ['Sizes', 'front 125/81 R20 li 96, one rear 155/65 R20 li 102 (wheels-17: 135/75 R20 li 100 at four corners)'],
        ['Rolling resistance', '3.8 kg/t booked unchanged; both deflections now 3.5 mm against Gen 20\'s 6.3, so the carried figure got more conservative, not less. See CRR_BASIS'],
        ['Cold pressure', '5.6 bar, one placard figure for all three corners'],
        ['Patches', 'front 61.5 cm2 at 351 kg laden static, rear 91.1 cm2 at 520; both 100 mm long on their net widths'],
...
const SECT = 0.0625;             // 125 mm section: half-width, local axial
...
const TIRE_F = tireProfile(SECT, RIMW, LIP, OFF, 125 / 135);
...
const PANT = {
  ...
  ZOUT: 0.8155,    // Gen 21: the disc follows the 125 face in 10 mm (world 0.7955); 18 mm off the section max, as always
