...
export const SYSTEM = {
  ...
  parts: {
    ...
    busbars: {
      name: 'Aluminium busbars and collectors',
      tagline: 'No copper anywhere in the pack: sodium, unlike lithium, permits an aluminium anode collector.',
      mass: 5,
      specs: [
      ...
      fail: [
        ...
        'Aluminium creeps under bolted joints, so the serviceable terminals torque through spring washers and get a recheck interval, a maintenance line copper never needed.',
...
export function build() {
  ...
  /* busbars: aluminium spine, per-row strips, end jumpers, and the two
  ...
  /* lid: moulded SMC panel, perimeter bolts, two rear burst discs */
