...
export const SYSTEM = {
  ...
  interfaces: {
    ...
    'front-pant-bracket': {
      kind: 'face', axis: 'z', at: 0.5830, tol: 0.002,
  ...
  parts: {
    ...
    'rear-saddles': {
      ...
      fail: [
        ...
        'THE RISER PASSES 17 mm FROM THE BODY FLANK, a wheel-borne tube beside a sprung panel, and the suspension\'s lateral compliance under cornering is not in the model; a first draft at the flank\'s own plane was 11.3 mm inside it and the checker, not the drawing, said so.',
...
const PANT = {
  ...
  ZIN_NOSE: 0.665, // band inboard edge on the nose, from 58 deg down, carried
  ZIN_TAIL: 0.725, // band inboard edge on the tail, from 58 deg down: wheels-13's 0.690 put the tail tip 3.6 mm from hv-11's spine at full lock and full rebound; wheels-14's 0.715 read 6.7 mm from hv-15's zonal box by surface (tools/envelope.sh); 0.725 reads 17
