/* Interior, Gen 11: THE TANDEM CABIN.
   ...
   that no longer have a neighbour to protect anyone from, and the head
   ...
   - body-11 doors and skin: cabin inner face |z| 0.6000. Canopy |z| 0.5976,
     glass to y 1.3300. Loft crown y 1.3220 on the centreline.
   - body-11 cage: THREE full-width bows whose SOFFIT is y 1.2990, at x 0.300,
     ...
     canopy-liner panel: that one millimetre is the whole fix.
   ...
   DECLARED_CONTACTS list that recognises `front-seats`, `rear-bench`,
...
export const SYSTEM = {
  ...
  /* WHERE THE PEOPLE ARE, declared rather than left to be guessed. These are
     ...
     seats that share a centreline. A declaration is still a CLAIM: the tool
  ...
  occupants: [
    ...
    /* legZ is the half-separation of the feet, and the rear occupant's are
       ...
       packaging argument. It is the CHANNEL centre and not a stance, and an
       ...
       so its centre is 0.4558 and the tread under it is built at 0.4505.
  ...
  parts: {
    ...
    displays: {
      ...
      specs: [
        ...
        ['Centre display', '13 in, 2800 x 1180, optically bonded, 1400 cd/m2'],
      ...
      fail: [
        ...
        'The rear repeater is 623 mm from the rear occupant and 110 mm wide, so it is legible and uninformative by design. Anyone who wants to know WHY a lane went down has to ask the person in front, and that is a genuine regression against a shared centre panel.',
        'A colour-blind rear occupant gets segment position and motion and nothing else, because there is no room for words on a 110 mm strip.',
      ],
      explode: [0.62, 0.6, 0],
    },
    wheel: {
      name: 'Hand wheel and feel unit',
      tagline: 'The one part of interior-6 that moves to the centreline and gets simpler doing it: a tandem driver sits on the car\'s axis of symmetry, so the wheel does too.',
      mass: 10,
      specs: [
      ...
      fail: [
        ...
        'Feel is a calibration liability with 90 Hz of authority behind it, and a bad release now makes good hardware drive badly on the centreline where both hands feel it equally.',
      ],
      explode: [0.45, 0.15, 0],
    },
    'front-seats': {
    ...
    luggage: {
      ...
      tagline: 'design/gen11.md section 9 item 3 names luggage as an unpriced capability cost and hands it to this module. The answer is 61 litres, and it is not a good answer.',
      mass: 5,
      specs: [
      ...
      fail: [
        ...
        'Sixty-one litres is the number with the locker empty of anything else, and thermal-11, hv-11 and autonomy-11 are all still being drawn for this generation. It is the first free void any of them will look for, and this module has no claim on it stronger than having drawn it first.',
      ],
      explode: [-0.5, 0.35, 0],
    },
    pedals: {
    ...
    nvh: {
      name: 'NVH package',
      tagline: 'A tandem cabin is a tube, and a tube has axial modes a box does not: the 2.9 m cavity between the windscreen and the tail bulkhead resonates at 59 Hz with both occupants on the axis, which is the worst place to sit.',
      mass: 5,
      specs: [
      ...
      fail: [
        ...
        'The 59 Hz figure is a rigid-wall estimate on a measured length. The real cavity has a compliant canopy, a tensioned liner and two people in it, all of which move it and none of which are modelled here, so it is a design target rather than a measurement.',
        'battery-11\'s carbon lid is still 5 dB lighter-and-louder than an aluminium floor by the mass law, and constrained-layer tiles address panel resonance rather than mass-law transmission. That debt is inherited from Gen 5 and this module does not pay it.',
        'Absorption is a volume game and this car has no volume: both wheelhouses are full of suspension-9 and wheels-11 and there is no boot at all. What ships is 5 kg of damping and control with almost no absorber in it, which is a real regression against interior-6, and it is priced at zero here only because nothing was drawn.',
      ],
      explode: [0, -0.35, 0],
    },
    restraints: {
      ...
      specs: [
        ...
        ['Deleted', 'Centre far-side bag, passenger 90 L bag, two curtains'],
...
/* ── Geometry ──────────────────────────────────────────────────────────────
   ...
   - body-11 cage bows, soffit y 1.2990 at x 0.300 and -1.100. The liner
     ...
     |z| 0.097 so the head-box corners get the same 50.1 mm as its centre.
   ...
   - NO CENTRE CONSOLE. A console is furniture between two people sitting
...
/* The same with all twelve edges chamfered: 44 triangles against 12, and it
   is most of the difference between a moulding and a rectangle. */
...
/* An upholstered or moulded panel: linear interpolation, grooves for the
...
function buildSeat(g, hx, feet, sideX, front) {
  ...
  /* THE REAR FOOTWELL DECK, on the front seat only, because it is a wing off
     ...
     centreline at x 0.2100 to find the floor the heel lands on, and with
...
export function build() {
  ...
  const wheelP = lib.part('wheel', [0.45, 0.15, 0]);
  {
    ...
    /* ── THE MOUNT, WHICH THIS PART DID NOT HAVE ──────────────────────────
       ...
       THE ROUTE IS OUTBOARD BECAUSE THE CENTRELINE IS FULL, and that was
