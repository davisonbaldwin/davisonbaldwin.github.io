/* Wheels and brakes, Gen 13: the corner does not move, and the front wheel
...
export const SYSTEM = {
  ...
  parts: {
    ...
    'front-pants': {
      ...
      tagline: 'The first fairing on this ladder over a wheel that steers. It steers too, so its gap to the tire is the same at every lock and every bump.',
      mass: 5.8,
      count: 2,
      specs: [
        ['Counterpart', 'body-12 rear spats, 12 kg: a wall on the body beside a wheel that does not steer. body-3 front spats, 5 kg, skirted only the crescents a steered wheel cannot reach'],
        ['Disc', '|z| 0.8255 outer face, r 0.400 about the axle, clipped at y 0.080; 16.0 mm off the tire section max, 14.5 off the cover lip'],
        ['Band', 'r 0.400 (41 mm over the tread at the crown), 70 degrees each side of the top, |z| 0.680 to 0.8255 at the crown, inboard edge tapering to 0.720 by 50 degrees'],
        ['Bracket', 'Knuckle face (1.505, 0.470, 0.583) up the leading side at x 1.500, |z| 0.635, to the band underside at (1.458, 0.738, 0.690)'],
        ['Tightest', '18 mm, bracket arm over the tire shoulder at |z| 0.69; 12 mm, bracket leg to the flank at 14 degrees of lock'],
        ['Mass', '2.17 kg of 4 mm carbon sandwich at 3.5 kg/m2 over 0.619 m2, 0.55 kg of aluminum arm, 0.20 of fixings: 2.9 a corner, unsprung'],
      ...
      how: 'THREE PIECES AND A DECISION. The disc is a flat 4 mm carbon sandwich in the plane |z| 0.8255, a circle of r 0.400 about the axle cut off flat at y 0.080, so it hides the tire\'s whole outboard face from 80 mm above the road to 45 mm over its crown. The band is the same laminate bent to r 0.400 over the crown, from 70 degrees ahead of the top to 70 degrees behind it, which is y 0.492 at each end, reaching inboard to |z| 0.680 at the crown. Its inboard edge tapers to 0.720 by 50 degrees, and that taper is the decision: a point 0.306 m off the kingpin plane swings 74 mm at 14 degrees of lock, and at 50 degrees the band is at y 0.612, just above the flank\'s bottom edge at 0.608, so an edge at 0.680 there would pass 6 mm from the flank at full lock and one at 0.720 passes 46. At the crown the edge does not swing at all, because it is on the kingpin plane. THERE IS NO INBOARD WALL, on the same arithmetic: a wall at |z| 0.650 running the tire\'s length would put its ends 0.355 m off the plane and swing them 86 mm to 0.564, inside a flank at 0.600, and the tire\'s own inboard corner already does exactly that, which is the foul Gen 11 recorded at 3.0 degrees and body-13 relieves. So the tire\'s inboard shoulder above the flank stays in the air and the buildup charges it.\n\nTHE BRACKET GOES UP THE LEADING SIDE, AND WHERE IT GOES WAS SWEPT. suspension-9\'s front upright presents its outboard face at |z| 0.5830 over x 1.377 to 1.5155 and y 0.217 to 0.583; its upper ball joint stands at (1.450, 0.558, 0.625) and its caliper arch wraps the trailing-upper quadrant to 0.6475. The foot therefore lands at (1.505, 0.470), 55 mm ahead of the joint and clear of the arch, and the arm leaves it outboard and up: to (1.500, 0.495, 0.635), vertically to (1.500, 0.725, 0.635), then over the shoulder to (1.458, 0.738, 0.690), where a 30 mm pad meets the band\'s inner face at r 0.396. The vertical leg sits in the 72.5 mm between the flank at 0.600 and the tire\'s section maximum at 0.6725, 24 mm from one and 26.5 from the other at zero lock; at 14 degrees the leg, 50 mm ahead of the axle, swings 12 mm toward the flank and 12 is the published figure. Over the shoulder the arm\'s underside is 18 mm above the tread at |z| 0.69, the tightest clearance on the part; it is constant through bump and lock because the tire and the arm are one rigid body, and it is 14 mm after the 1 percent of radial growth the tire panel prices at speed.\n\nWHAT THE DRAG BUILDUP SEES, and it is the reason the module and not the body draws this. Under the third revision of tools/aero.js a static part of the wheels module is background for the wheel term, so the disc and the band hide the rotating tire\'s shadow the way body-12\'s spats hide the rears\', and the shell itself is charged friction on its wetted surface with the car\'s form factor. The tire below y 0.080 stays exposed, 0.135 by 0.080 m a wheel, and so does its inboard shoulder between |z| 0.6725 and 0.680 above the flank. The frontal area the pant adds, a disc standing 18 mm outside the tire column and a band 45 mm over it, is measured by tools/area.sh and written into js/efficiency.js AREA by the sweep, never here.',
      why: 'Because the number said so and the two objections to a front fairing were both objections to a FIXED one. design/retro-gen12.md section 4 measured the wheels at a quarter of Gen 12\'s coefficient and the fronts at half of that, and design/gen12-front.md declined a front spat because a tire that swings 85 mm at lock cannot share a wall with a body and because the body has nothing below y 0.608 at a wheel station to hang one from. A shell on the upright has a constant gap to its own tire and hangs from the upright, which is how a record car and a production three-wheeler both fair a wheel that steers. The cost it takes instead is unsprung mass, 3 kg a corner, and a part that moves in the wind at every steering input; the panel prices both rather than the area, because the area is the sweep\'s to state.',
      fail: [
        'THE PANT IS IN THE WIND AT LOCK. At 14 degrees the disc presents its face 14 degrees to the stream and the band\'s ends swing 97 mm; at parking speeds that is nothing and at the 10 degrees a fast lane change needs it is a yawing moment on the upright the steering has to hold. Nothing in this project models an unsteady side load on a steered fairing, and the rack authority suspension-9 publishes was sized without it.',
        'UNSPRUNG MASS, PRICED. 2.9 kg a corner on a corner of about 21 kg is plus 14 percent, and it is all at r 0.40 on a part that steers, so the kingpin inertia rises more than the mass does. suspension-9\'s active dampers were tuned on the lighter corner; the ride penalty is real and unmeasured here.',
        'THE ARM PASSES 18 mm OVER A TIRE THAT GROWS. Radial growth at speed and a flat-spotted cold casing both eat that gap from below, and a stone between the arm and the tread has 18 mm to lodge in. Aptera-class pants run similar gaps and run them with a liner; this one has no liner drawn.',
        'THE BRACKET FOOT LANDS ON A FACE NOBODY DECLARED. suspension-9 is carried unchanged and its knuckle does not declare |z| 0.5830 as an interface, so tools/check-interfaces.sh warns this key unmet rather than proving it, and a future knuckle that moves its face moves the pant with it silently. A suspension generation that redraws the front corner owes the other half of the key.',
        'THE INBOARD SHOULDER IS OPEN AND THE ARCH POCKET IS THE BODY\'S. The tire from |z| 0.6725 to 0.680 above the flank is charged as exposed, and the tire\'s inboard corner still swings into a 0.60 flank above y 0.608 at the tire ends, the foul Gen 11 recorded. This module cannot close either without an inboard wall whose ends would swing further than the tire\'s own. body-13 relieves the arch; until a body does, the foul stands in the panel that owns it.',
        'A FULL DISC IS A FULL DISC IN A CURB STRIKE, and it is now the outermost thing on the car at |z| 0.8255, 16.5 mm proud of the cover lip that used to be. It is also the part that meets a curb on the steered wheel, where a curb is met at an angle. A cracked pant is a whole pant, and the mount is designed to shear before the upright does.',
      ],
      explode: [0, 0, 1.25],
    },
    'rear-wheels': {
...
/* ── THE FRONT PANTS, new for Gen 13. World coordinates about the front axle
   at (P.axleF, P.wheelY, s * FRONTZ); s = sign(z) so +s is outboard. The
   module header carries every clearance and the swept envelope; the panel
   carries the why. Nothing here spins. ── */
const PANT = {
  R: 0.400,        // band radius about the axle: 45 mm over the tire's 0.355
  ZOUT: 0.8255,    // disc outer face, 18 mm off the tire section max at 0.8075
  ZIN: 0.700,      // band inboard edge over the crown, |theta| <= 48 deg
  ZIN_NOSE: 0.665, // band inboard edge on the nose, from 58 deg down
  ZIN_TAIL: 0.690, // band inboard edge on the tail, from 58 deg down
  Y0: 0.080,       // disc lower edge, above the road by 80 mm
  TH: 0.004,       // laminate
  ARC_NOSE: 125,   // the nose cap reaches down to y 0.126 at x 1.778
  ARC_TAIL: 61,    // the tail stops at y 0.549 at x 1.100: battery-11's sill runs to x 1.080 at |z| 0.720 to 0.780, 15 mm behind the tire, and a tail past 61 degrees stands inside it (measured 45.5 mm at 95)
};
...
function frontPantPart(s) {
  ...
  shape.absarc(0, 0, PANT.R, a0, Math.PI - a0, false);
  shape.closePath();
  const discGeo = new THREE.ExtrudeGeometry(shape, {
    depth: PANT.TH, steps: 1, curveSegments: 48,
  ...
  /* THE BAND IS THE POD: one closed thin section lofted around the wheel
     ...
     the band reads solid. The inboard edge is 0.700 over the crown, where
     the flank stands at 0.600 above y 0.608 and a point off the kingpin
     plane swings into it at lock; it steps inboard to 0.665 on the nose
     below 58 degrees (y 0.567, under the flank, and 20 mm clear of the
     venturi closeout at lock) and to 0.690 on the tail (the pack's corner
     closeout at |z| 0.655 and the recorded lock foul live there). */
  const zin = (deg) => {
    const t = Math.max(0, Math.min(1, (Math.abs(deg) - 48) / 10));
    const end = deg >= 0 ? PANT.ZIN_NOSE : PANT.ZIN_TAIL;
    return PANT.ZIN + (end - PANT.ZIN) * t;
  };
  const rows = [];
  for (let deg = -PANT.ARC_TAIL; deg <= PANT.ARC_NOSE + 1e-9; deg += 5) {
  ...
  /* THE BRACKET: foot on the knuckle's outboard face at |z| 0.5830, arm up
     the leading side at x 1.500 and |z| 0.635, over the shoulder to the
     band's underside at (1.458, 0.738, 0.690). */
  const KF = 0.5830;
  ...
  g.add(lib.tube([
    ...
    [1.500, 0.725, s * 0.6350],
    [1.480, 0.750, s * 0.6720],
    [1.458, 0.738, s * 0.7120],
  ], 0.011, M.castAlu, false, 12));
  /* the pad between the arm's end and the band's inner face at r 0.396 */
  const pad = lib.cbox(0.030, 0.002, 0.030, 0.001, M.castAlu);
  pad.position.set(1.458, cy + (PANT.R - PANT.TH) - 0.001, s * 0.712);
  g.add(pad);
  return g;
}
...
export function build() {
  ...
  for (const [x, z] of corners) {
    ...
    /* and the pant, static, on the front corners only */
    if (front) sys.add(frontPantPart(s));
  }
