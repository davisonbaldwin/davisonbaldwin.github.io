...
export const SYSTEM = {
  ...
  parts: {
    ...
    bands: {
      ...
      tagline: 'Gen 2 squeezed each stack with seven tonnes of tie rods; the apex brick wears a wound carbon bandage that never lets go.',
      mass: 4,
      count: 15,
      specs: [
    ...
    rockerrails: {
      ...
      fail: [
        ...
        'A side pole that bottoms all three chambers puts end plates and layers into the load path; the film’s strain and tap grid localises the damage to the brick, and the repair boundary after such a hit is the body shell itself, not the pack, the same line Gen 3 drew.',
    ...
    floorlid: {
      ...
      specs: [
        ...
        ['Replaces', 'Gen 3 aluminium floor-lid, 21 kg'],
...
const BX = [-0.76, -0.312, 0.136, 0.584, 1.032];   // brick centres, 0.448 pitch
const GAPX = [-0.536, -0.088, 0.36, 0.808];        // vapor riser gaps
const BRICK_L = 0.42, BRICK_H = 0.135, BRICK_W = 1.30;
const BRICK_Y = 0.2075;         // brick centre height: spans 0.140 to 0.275
