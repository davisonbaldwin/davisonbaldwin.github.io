  ...
  parts: {
    ...
    'v2g-port': {
      ...
      specs: [
        ...
        ['Aperture', 'Datum x -1.845, y 0.790; flank |z| 0.5600 measured on body-15 (hv-11: 0.6000 on body-11)'],
...
const PORT  = [-1.8450, 0.7900, 0.5320];   /* Gen 15: 40 mm inboard, body-15's flank at 0.5600 */  /* charge aperture datum, which is
   ...
   P is NOT touched. */
const VBOX  = [-1.8900, 0.7100, 0.3900];   /* Gen 15: 40 mm inboard with the port */  /* V2G electronics, case
