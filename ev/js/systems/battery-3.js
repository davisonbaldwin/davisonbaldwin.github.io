...
export const SYSTEM = {
  ...
  parts: {
    ...
    cooling: {
      ...
      fail: [
        'The pan under the fluid is a 2 mm boundary, not armour; strike protection belongs to the body floor and a sacrificial skid, and a breached pan is a fluid loss the level sensor reports before the isolation monitor has anything to say.',
...
const NBLADES = 44;
const PITCH = 0.052;
const X0 = -0.978;              // first blade centre; rear bay lives behind it
const BLADE_T = 0.046, BLADE_H = 0.135, BLADE_L = 1.40;
const BLADE_Y = 0.2075;         // blade centre height: spans 0.14 to 0.275
...
export function build() {
  ...
  for (const zs of [-1, 1]) {
    ...
    /* rails stop short of the wheel arches (|x| <= 1.08) so they never
