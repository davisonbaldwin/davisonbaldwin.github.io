...
/* GEN 19: THE BOAT TAIL. body-18 with 600 mm of closing tail appended past
   its Kamm face, the Kamm spoiler deleted, the diffuser flap fixed, the
   surround camera pod flush. design/gen19.md is the brief; its section 4b
   holds the measured sweep this geometry reproduces. Everything not named
   there is body-18's, byte for byte, and the notes below this block are the
   inherited record. */
...
export const SYSTEM = {
  ...
  parts: {
    ...
    skin: {
      ...
      mass: 43.3,   /* Gen 18: 34.8 x 1.2435, the drawn area on this loft over body-17's, tools measured: the hatch from -0.490 is skin where the rear glass was */   /* 35.7 x 0.9736: the drawn area on this loft over body-14's, tools measured */   /* 36 x 0.9919: the skin's drawn area on this loft over body-13's, tools measured */
      specs: [
    ...
    spats: {
      ...
      mass: 15.9,   /* Gen 18: 12 x 1.3236, the drawn area over body-17's, tools measured: the trailing closure runs 670 mm instead of 160 */
      specs: [
    ...
    canopy: {
      ...
      mass: 9.3,    /* Gen 18: 13.1 x 0.7061, the drawn area on this loft over body-17's, tools measured: the glass ends at -0.450 */   /* 13.5 x 0.9667: the drawn area on this loft over body-14's, tools measured */   /* 14 x 0.9642: the canopy's drawn area on this loft over body-13's, tools measured */
      specs: [
...
const STATIONS = [
  ...
  [-0.350, [...SHLD,
            [0.965, 0.560], [1.040, 0.551], [1.215, 0.384], [1.254, 0.300]], 1.257],
...
function buildShell(sys) {
  ...
  const SPAT = [
    ...
    [-1.780, 0.8200, SPAT_TOP], [-1.900, 0.8000, SPAT_TOP - 0.010, 0.7800], [-2.060, 0.7500, SPAT_TOP - 0.030, 0.6000], [-2.250, 0.6400, SPAT_TOP - 0.060, 0.5100], [-2.400, 0.5300, SPAT_TOP - 0.085, 0.4650],
  ];
  for (const side of [-1, 1]) {
    ...
    const rows = SPAT.map(([x, hz, top, hzLo]) => {
      ...
      return [[x, 0.1800, side * lo], [x, (0.1800 + top) / 2, side * ((hz + lo) / 2 + 0.0020)], [x, top, side * hz]];
    });
