/* Gen 15 body: the flank.
   ...
   from the runs and not from the drawing:
     frontal area     1.6062 m2 on wheels-15 against body-14's 1.6398 on
...
export const SYSTEM = {
  ...
  closures: {
    door: {
      ...
      mass: 19,
      seconds: 1.6,
      seat: 'Deck shoulder at y 1.2230, axis along x at |z| 0.3585, inboard of the cage roof rail: body-13\'s 8 mm over and 21.5 mm inboard of a shoulder that moved to (1.215, 0.380) (body-13: 1.2380, 0.3685)',
      motion: [
...
function buildShell(sys) {
  ...
  const closeF = lib.plate(0.78, 1.13, 0.012, 0.04, M.carbon);
