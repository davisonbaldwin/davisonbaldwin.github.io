...
export const SYSTEM = {
  id: 'suspension-16',
  name: 'Suspension · Gen 16 the corner',
  color: 0xc0a2ec,
  explode: [0, -0.62, 0],
  interfaces: {
    ...
    'front-halfshaft-outboard': {
      ...
      note: 'the hub flange outboard face, the plane wheels-15 clamps on and drivetrain-9 lands its CV flange on; the knuckle part reaches it and goes no further, which extent max asserts.',
    },
  },
...
export function build() {
  ...
  const RY = 0.36;
  const rack = lib.cyl(0.015, 0.96, M.steel, 14);   /* 30 mm bar, Gen 16: see the steering panel */
